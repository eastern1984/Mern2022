...
exports.app.use((0, express_session_1.default)({ secret: process.env.SECRET_SESSION_STRING || "", resave: false, saveUninitialized: false, store: store })).use((0, connect_flash_1.default)());
exports.app.use(body_parser_1.default.json());
exports.app.use(body_parser_1.default.urlencoded({ extended: false }));
exports.app.use(process.env.API_URL || "", loginRoutes_1.router);
